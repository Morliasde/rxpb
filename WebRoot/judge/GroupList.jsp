    ...
    <div class="main">
		...
		<c:forEach var="group" items="${groups}" varStatus="order">
						<tr <c:if test="${order.count%2==0 }">bgcolor="cacaca"</c:if>>
							...
							<td><a href="judge/getQualityByJudge?groupId=${group.groupId}&groupQueue=${order.count}">种质评分</a>
							<a href="judge/getTasteByJudge?groupId=${group.groupId}&groupQueue=${order.count}">口感评分</a>
							</td>
